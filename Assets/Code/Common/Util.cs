...
static public class Util : object {
    ...
    static public float GetDirection(Transform transform1, Transform transform2) {
        return GetDirection(transform1.position, transform2.position);
    }

    static public float GetDirection(Vector3 pos1, Vector3 pos2) {
        Vector2 point1 = new Vector2(pos1.x, pos1.z);
        Vector2 point2 = new Vector2(pos2.x, pos2.z);
        return GetDirection(point1, point2);
    }
