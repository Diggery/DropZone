...
//Last modified: Tue, Oct 11, 2016 08:41:28 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -637.23848624132279 393.71082817272259 978.16538338111059 ;
	setAttr ".r" -type "double3" -12.938352729584979 -393.39999999994382 -4.7621770705454099e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CC00F1CE-0347-CFA4-D46A-8685B3A27D4F";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 1165.7654959824181;
...
createNode fosterParent -n "AssaultRifleRNfosterParent1";
	rename -uid "1E913B16-D447-1276-60FC-4EB917304262";
createNode parentConstraint -n "AssaultRifle_parentConstraint1" -p "AssaultRifleRNfosterParent1";
	...
	setAttr ".lr" -type "double3" 77.231100463787854 -0.53823245539389053 -2.3736116949853434 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F5654784-4F4E-AAE1-8CEE-BAA70030285B";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "1E4DADE8-714E-D9EB-E4FF-A08BA3C93FE4";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "64CED34D-A941-38EC-0AA2-D5B3B1DCAD93";
...
createNode reference -n "CombotRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -1.00682075087729972 0.25607789027271005 -1.3504641847779153"
		...
		"rotate" " -type \"double3\" -1.62002313620529703 -4.6520385493346576e-05 8.9809255351371104e-05"
		...
		"rotate" " -type \"double3\" 2.61625378936521225 -0.75578707639129239 1.14799928634288917"
		...
		"rotate" " -type \"double3\" 2.19058054337531072 0.91971302239693264 -0.065863889606998155"
		...
		"rotate" " -type \"double3\" -4.48210337670521053 -0.00012962218789370686 0.00025024039601825816"
		...
		"rotate" " -type \"double3\" 2.29319458685274702 -0.8758107256334885 -0.28818225879762094"
		...
		"CombotRN.placeHolderList[10]" ""
		5 3 "CombotRN" "Rig:skinCluster5.outputGeometry[0]" "CombotRN.placeHolderList[11]" 
...
select -ne :ikSystem;
	...
	setAttr -av ".gsn";
	setAttr -k on ".gsv";
connectAttr "polySoftEdge1.out" "CombotRN.phl[2]";
connectAttr "CombotRN.phl[3]" "polySoftEdge1.mp";
connectAttr "CombotRN.phl[4]" "AssaultRifle_parentConstraint1.tg[0].tt";
connectAttr "CombotRN.phl[5]" "AssaultRifle_parentConstraint1.tg[0].trp";
connectAttr "CombotRN.phl[6]" "AssaultRifle_parentConstraint1.tg[0].trt";
connectAttr "CombotRN.phl[7]" "AssaultRifle_parentConstraint1.tg[0].tr";
connectAttr "CombotRN.phl[8]" "AssaultRifle_parentConstraint1.tg[0].tro";
connectAttr "CombotRN.phl[9]" "AssaultRifle_parentConstraint1.tg[0].ts";
connectAttr "CombotRN.phl[10]" "AssaultRifle_parentConstraint1.tg[0].tpm";
connectAttr "CombotRN.phl[11]" "polySoftEdge1.ip";
