...
//Last modified: Wed, Jan 29, 2020 08:07:59 AM
//Codeset: UTF-8
...
fileInfo "UUID" "5F6AB70D-CD4C-84E1-71D7-F4AE35ACFB85";
...
createNode parentConstraint -n "Weapon_MkII1_parentConstraint2" -p "Weapon_SidewinderRNfosterParent1";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -117.27126513556432 -164.06635527003365 150.03736608788802 ;
...
createNode fosterParent -n "SquaddieRNfosterParent1";
	rename -uid "CE1A5EBD-2147-6FB3-6F34-4EA7F8E5BDFE";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "56AA5E3B-9746-9A21-CC33-308D68FFF9D3";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "E5C91E6D-3D4E-5B5D-A5D4-AA96BCEEDA12";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CE5AF697-7F4F-0066-9BE2-FB80A01D070E";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "4F4A93B8-5947-7084-81A2-88B3C2992DDC";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "73E4AD5F-EA4F-4848-C1D8-93BC7489F6FA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "59408776-B840-23F1-A37D-4FBF11D0C476";
createNode reference -n "SquaddieRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translateZ" " -av"
		2 "|Squaddie:Root_Control|Squaddie:RootMotion_Control|Squaddie:Hips_Control" 
		"rotate" " -type \"double3\" 7.61498601623299542 -20.25874108797238904 -2.24098269225893887"
		...
		"translateZ" " -av"
		2 "|Squaddie:Root_Control|Squaddie:RootMotion_Control|Squaddie:Hips_Control|Squaddie:Spine1_Control" 
		"rotate" " -type \"double3\" 6.62893962185093688 -14.80442443035410349 0.17707083829317488"
		...
		"translateZ" " -av"
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:Spine1_Skel|Squaddie:Spine2_Skel|Squaddie:LeftClav_Skel|Squaddie:LeftUpperArm_Skel" 
		"rotate" " -type \"double3\" 9.36734874376637272 -25.50634907421219566 -15.16286319414962236"
		...
		"rotate" " -type \"double3\" 0 -72.91991268810673432 0"
		...
		"translateZ" " -av"
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:Spine1_Skel|Squaddie:Spine2_Skel|Squaddie:RightClav_Skel|Squaddie:RightUpperArm_Skel" 
		"rotate" " -type \"double3\" 31.52738725569552969 20.8662892874323056 12.56437584674678654"
		...
		"rotate" " -type \"double3\" -0.0030378563481493694 -79.425793769134998 0.002625990019489001"
		
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:LeftUpperLeg_Skel" 
		"translate" " -type \"double3\" 19.81883811950683949 1.35854452727749653 -7.39106094254957213"
		...
		"translateZ" " -av"
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:LeftUpperLeg_Skel" 
		"rotate" " -type \"double3\" -55.46377682563341693 18.21385229195797706 -22.01064088800808705"
		...
		"rotate" " -type \"double3\" 33.0058573621950373 0 0"
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:RightUpperLeg_Skel" 
		"translate" " -type \"double3\" -19.81879997253418679 1.35854880205052275 -7.39109886124327886"
		...
		"translateZ" " -av"
		2 "|Squaddie:SkeletonGroup|Squaddie:Attach_RootMotion|Squaddie:Hips_Skel|Squaddie:RightUpperLeg_Skel" 
		"rotate" " -type \"double3\" -29.73636717398035501 18.26448746614499896 -42.18326396384737365"
...
createNode animCurveTL -n "Root_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0 12 0 25 0 50 0 60 0 70 0 75 0 79 0 85 0
		 90 0;
...
createNode animCurveTL -n "LeftFoot_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 -0.74791060811137555 4 -0.74791060811137555
...
createNode animCurveTL -n "LeftFoot_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 -5.6843418860808015e-14 4 0 6 9.8077466536504136
		 9 0 12 0 25 -5.6843418860808015e-14 50 0 60 0 70 0 75 0 79 0 85 0 90 0;
createNode animCurveTL -n "LeftFoot_Control_translateZ";
	rename -uid "5433778F-CB49-B7B4-B178-0C98411E04DF";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 1.0532878247975219 4 1.0532878247975219
...
createNode animCurveTL -n "RightFoot_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 2.6895161715317322 2 2.6895161715317322
...
createNode animCurveTL -n "RightFoot_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 2 0 4 12.241169205179142 6 0 12 0 25 0
...
createNode animCurveTL -n "RightFoot_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 -3.3219774388475543 2 -3.3219774388475543
...
createNode animCurveTL -n "Hips_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 0 12 0 25 0 32 -1.7623579484924328 42 0.27685814475166115
...
createNode animCurveTL -n "Hips_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 -2.8201754079675112 4 -0.89958184934956265
...
createNode animCurveTL -n "Hips_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  0 -4.4222906818613694 12 -4.4222906818613694
...
createNode animCurveTL -n "LeftElbow_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -36.59420188088145 12 -36.59420188088145
...
createNode animCurveTL -n "LeftElbow_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -3.3722819566655033 12 -3.3722819566655033
...
createNode animCurveTL -n "LeftElbow_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -4.5438695071146675 12 -4.5438695071146675
...
createNode animCurveTL -n "LeftHand_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  0 -40.265092482207002 6 -33.453757467319903
...
createNode animCurveTL -n "LeftHand_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  0 2.0397669374667693 6 3.7955764638459271
...
createNode animCurveTL -n "LeftHand_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 14 ".ktv[0:13]"  0 31.030649679219252 6 32.696402530142507
...
createNode animCurveTL -n "RightElbow_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 4.2736108606484144 12 4.2736108606484144
...
createNode animCurveTL -n "RightElbow_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -26.696346089392271 12 -26.696346089392271
...
createNode animCurveTL -n "RightElbow_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 19.430826289748698 12 19.430826289748698
...
createNode animCurveTL -n "RightHand_Control_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  0 46.788145633152332 5 5.1704370820684487
...
createNode animCurveTL -n "RightHand_Control_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  0 0.39352732838451082 5 1.1454448456010777
...
createNode animCurveTL -n "RightHand_Control_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  0 -31.962316694080791 5 0.60860843466015413
...
createNode animCurveTU -n "LeftHand_Control_visibility";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 1 12 1 25 1 50 1 60 1 70 1 75 1 79 1 85 1
		 90 1;
createNode animCurveTA -n "LeftHand_Control_rotateX";
	rename -uid "C7F4514B-7841-5CC6-8C28-E1BEE93AD1F8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 -111.75567996540009 12 -111.75567996540009
...
createNode animCurveTA -n "LeftHand_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 -54.521263958697823 12 -54.521263958697823
...
createNode animCurveTA -n "LeftHand_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 37.382383125556167 12 37.382383125556167
...
createNode animCurveTA -n "Head_Control_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 -26.541382566847698 25 -26.541382566847698
...
createNode animCurveTA -n "Head_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 41.334750760673558 25 41.334750760673558
...
createNode animCurveTA -n "Head_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 -10.746053674015032 25 -10.746053674015032
...
createNode animCurveTA -n "RightHand_Control_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  0 63.646130614950742 5 120.2020163413803
...
createNode animCurveTA -n "RightHand_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  0 37.429102475060958 5 52.148432578083096
...
createNode animCurveTA -n "RightHand_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  0 72.802776723557471 5 83.003881018964194
...
createNode animCurveTA -n "RightFoot_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 2 0 4 -21.562477175845654 6 0 12 0 25 0
		 50 0 60 0 70 0 75 0 79 0 85 0 90 0;
...
createNode animCurveTA -n "LeftFoot_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0 4 0 9 0 12 0 25 0 50 0 60 0 70 0 75 0
		 79 0 85 0 90 0;
...
createNode animCurveTA -n "Spine1_Control_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 6.6289396218509369 25 6.6289396218509369
...
createNode animCurveTA -n "Spine1_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0 12 -14.804424430354103 25 -14.804424430354103
...
createNode animCurveTA -n "Spine1_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0 12 0.17707083829317488 25 0.17707083829317488
...
createNode animCurveTA -n "Spine2_Control_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 7.3718086365500506 25 7.3718086365500506
...
createNode animCurveTA -n "Spine2_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 -2.9476933374420033 25 -2.9476933374420033
		 ...
		 85 -10.184446481455851 90 -10.184446481455851;
createNode animCurveTA -n "Spine2_Control_rotateZ";
	rename -uid "DC9C8DFA-E343-7764-5CAF-1FAC2B24F722";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 12 -2.2031979438817588 25 -2.2031979438817588
...
createNode animCurveTU -n "Hips_Control_visibility";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 1 12 1 25 1 50 1 60 1 75 1 79 1 85 1 90 1;
createNode animCurveTA -n "Hips_Control_rotateX";
	rename -uid "1FF1D9FA-0B4A-F9BB-CCE5-17997DB1282B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0 12 7.6149860162329954 25 7.6149860162329954
...
createNode animCurveTA -n "Hips_Control_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 0 12 -20.258741087972389 25 -20.258741087972389
...
createNode animCurveTA -n "Hips_Control_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 0 12 -2.2409826922589389 25 -2.2409826922589389
...
createNode animCurveTU -n "RightFinders_Control_Grip";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.5 12 0.5 25 0.5 50 0.5 60 0.5 70 0.5
...
createNode reference -n "Weapon_SidewinderRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"-s -r "
		2 "|Weapon_Sidewinder:Ripper" "rotate" " -type \"double3\" -117.2712651355643203 -164.06635527003365382 150.03736608788801732"
